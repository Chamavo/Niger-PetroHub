...
export default function Footer() {
  ...
  return (
    <footer className="bg-nav border-t border-white/10 py-12 pb-20 lg:pb-12">
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2">
                {navLinks.slice(0, 3).map((link) => (
                  <li key={link.href}>
                    <Link href={link.href} className="text-sm text-white/60 hover:text-accent-orange transition-colors">
                      {link.name}
                    </Link>
                  </li>
                ))}
